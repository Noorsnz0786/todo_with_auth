...
$result = mysqli_query($conn, "SELECT id, fullName,username, email, user_reg_date FROM users");
...
if($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    if(isset($_POST['edit_user'])){
        ...
        $sql = "UPDATE users SET email = '$new_email', fullName = '$fullName', username = '$new_username' WHERE id = $user_id";
        $result = mysqli_query($conn, $sql);
        $query_status = check_query($result);

        if($query_status === true){
            $_SESSION['message'] = "User updated successfully of {$new_username}";
...
<div class="container">
    ...
    <table class="user-table">
        ...
        <tr>
            ...
            <td><?php echo full_month_date($user['user_reg_date']); ?>
            </td>
            <td>
